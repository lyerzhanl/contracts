...
func (x *GetUserInfoByIdRequest) GetId() int32 {
	if x != nil {
		return x.Id
	}
	return 0
...
var file_auth_user_proto_rawDesc = []byte{
	...
	0x6f, 0x12, 0x04, 0x61, 0x75, 0x74, 0x68, 0x22, 0x48, 0x0a, 0x04, 0x55, 0x73, 0x65, 0x72, 0x12,
	...
	0x64, 0x22, 0x2a, 0x0a, 0x12, 0x47, 0x65, 0x74, 0x55, 0x73, 0x65, 0x72, 0x49, 0x6e, 0x66, 0x6f,
	...
	0x75, 0x73, 0x65, 0x72, 0x22, 0x28, 0x0a, 0x16, 0x47, 0x65, 0x74, 0x55, 0x73, 0x65, 0x72, 0x49,
	0x6e, 0x66, 0x6f, 0x42, 0x79, 0x49, 0x64, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x0e,
	...
	0x73, 0x65, 0x72, 0x52, 0x04, 0x75, 0x73, 0x65, 0x72, 0x32, 0xa5, 0x01, 0x0a, 0x0b, 0x55, 0x73,
	0x65, 0x72, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x44, 0x0a, 0x0b, 0x47, 0x65, 0x74,
	...
	0x50, 0x0a, 0x0f, 0x47, 0x65, 0x74, 0x55, 0x73, 0x65, 0x72, 0x49, 0x6e, 0x66, 0x6f, 0x42, 0x79,
	0x49, 0x64, 0x12, 0x1c, 0x2e, 0x61, 0x75, 0x74, 0x68, 0x2e, 0x47, 0x65, 0x74, 0x55, 0x73, 0x65,
	0x72, 0x49, 0x6e, 0x66, 0x6f, 0x42, 0x79, 0x49, 0x64, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74,
	0x1a, 0x1d, 0x2e, 0x61, 0x75, 0x74, 0x68, 0x2e, 0x47, 0x65, 0x74, 0x55, 0x73, 0x65, 0x72, 0x49,
	0x6e, 0x66, 0x6f, 0x42, 0x79, 0x49, 0x64, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22,
	...
	0x63, 0x74, 0x73, 0x2f, 0x67, 0x65, 0x6e, 0x2f, 0x67, 0x6f, 0x2f, 0x61, 0x75, 0x74, 0x68, 0x3b,
...
var file_auth_user_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_auth_user_proto_goTypes = []interface{}{
	(*User)(nil),                    // 0: auth.User
	(*GetUserInfoRequest)(nil),      // 1: auth.GetUserInfoRequest
	(*GetUserInfoResponse)(nil),     // 2: auth.GetUserInfoResponse
	(*GetUserInfoByIdRequest)(nil),  // 3: auth.GetUserInfoByIdRequest
	(*GetUserInfoByIdResponse)(nil), // 4: auth.GetUserInfoByIdResponse
}
var file_auth_user_proto_depIdxs = []int32{
	0, // 0: auth.GetUserInfoResponse.user:type_name -> auth.User
	0, // 1: auth.GetUserInfoByIdResponse.user:type_name -> auth.User
	1, // 2: auth.UserService.GetUserInfo:input_type -> auth.GetUserInfoRequest
	3, // 3: auth.UserService.GetUserInfoById:input_type -> auth.GetUserInfoByIdRequest
	2, // 4: auth.UserService.GetUserInfo:output_type -> auth.GetUserInfoResponse
	4, // 5: auth.UserService.GetUserInfoById:output_type -> auth.GetUserInfoByIdResponse
